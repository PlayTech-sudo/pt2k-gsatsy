						                  	...
						                  	<div class="row">
						                  		<div class="col-md-6 col-sm-12">
								                  	...
								                  	<div class="form-group bmd-form-group">
								                     	<div class="form-check">
																			...
																			<div class="form-check">
																			  <label class="form-check-label">
																			    <input class="form-check-input" type="checkbox" name="code[]" value="A07"> Definations
																			    <span class="form-check-sign">
																			      <span class="check"></span>
																			    </span>
																			  </label>
								                  ...
								                  <div class="col-md-6 col-sm-12">
								                  	...
								                  	<div class="form-group bmd-form-group">
								                  		<div class="form-check">
																			  <label class="form-check-label">
																			    <input class="form-check-input" type="checkbox" name="code[]" value="I01"> Inventory
																			    <span class="form-check-sign">
																			      <span class="check"></span>
																			    </span>
																			  </label>
								                  ...
								                  <div class="col-md-6 col-sm-12">
								                  	...
								                  	<div class="form-group bmd-form-group">
								                  		<div class="form-check">
																			  <label class="form-check-label">
																			    <input class="form-check-input" type="checkbox" name="code[]" value="S01"> sales invoices and tax management
																			    <span class="form-check-sign">
																			      <span class="check"></span>
																			    </span>
																			  </label>
																			...
																			<div class="form-check">
																			  <label class="form-check-label">
																			    <input class="form-check-input" type="checkbox" name="code[]" value="S02"> IN / OUT Status
																			    <span class="form-check-sign">
																			      <span class="check"></span>
																			    </span>
																			  </label>
																			...
																			<div class="form-check">
																			  <label class="form-check-label">
																			    <input class="form-check-input" type="checkbox" name="code[]" value="S03"> POS
																			    <span class="form-check-sign">
																			      <span class="check"></span>
																			    </span>
																			  </label>
								                  ...
								                  <div class="col-md-6 col-sm-12">
								                  	...
								                  	<div class="form-group bmd-form-group">
								                     	<div class="form-check">
																			  <label class="form-check-label">
																			    <input class="form-check-input" type="checkbox" name="code[]" value="M01"> Manufacturing
																			    <span class="form-check-sign">
																			      <span class="check"></span>
																			    </span>
																			  </label>
						                  	...
						                  	<div class="row">
						                  		<div class="col-md-6 col-sm-12">
								                  	...
								                  	<div class="form-group bmd-form-group">
								                     	<div class="form-check">
																			  <label class="form-check-label">
																			    <input class="form-check-input" type="checkbox" name="code[]" value="A06"> Cylinder Status Update
																			    <span class="form-check-sign">
																			      <span class="check"></span>
																			    </span>
																			  </label>
																			...
																			<div class="form-check">
																			  <label class="form-check-label">
																			    <input class="form-check-input" type="checkbox" name="code[]" value="A08"> Returnable Entry
																			    <span class="form-check-sign">
																			      <span class="check"></span>
																			    </span>
																			  </label>
																			...
																			<div class="form-check">
																			  <label class="form-check-label">
																			    <input class="form-check-input" type="checkbox" name="code[]" value="C03"> Cylinder Reports
																			    <span class="form-check-sign">
																			      <span class="check"></span>
																			    </span>
																			  </label>
								                  ...
								                  <div class="col-md-6 col-sm-12">
								                  	...
								                  	<div class="form-group bmd-form-group">
								                  		<div class="form-check">
																			  <label class="form-check-label">
																			    <input class="form-check-input" type="checkbox" name="code[]" value="C04"> Add Customer
																			    <span class="form-check-sign">
																			      <span class="check"></span>
																			    </span>
																			  </label>
																			...
																			<div class="form-check">
																			  <label class="form-check-label">
																			    <input class="form-check-input" type="checkbox" name="code[]" value="C05"> Customer Management
																			    <span class="form-check-sign">
																			      <span class="check"></span>
																			    </span>
																			  </label>
																			...
																			<div class="form-check">
																			  <label class="form-check-label">
																			    <input class="form-check-input" type="checkbox" name="code[]" value="C06"> Customer Reports
																			    <span class="form-check-sign">
																			      <span class="check"></span>
																			    </span>
																			  </label>
